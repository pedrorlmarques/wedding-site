<template>
  <div class="text-center prose mx-auto my-8">
    ...
    <p>
      Para que o nosso dia seja memorável e para que o possamos recordar no futuro, partilhem connosco fotografias e vídeos que capturaram
      durante os vários momentos, não se inibam :)
      Gostávamos ainda de reforçar que podem tirar fotografias e filmar, respeitem apenas o trabalho dos fotógrafos e videógrafos.
    </p>
  </div>
  ...
  <div class="my-4 w-full sm:mt-0 sm:w-auto" v-if="publications.length">
    <ul>
      <li
          ...
          :key="publication.id"
          class="mt-4 bg-white rounded-xl shadow-lg border border-gray-200 p-8 cursor-pointer">
